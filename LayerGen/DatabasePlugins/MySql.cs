    ...
    public class MySql : IDatabasePlugin
    {
        ...
        public void CreateCsUniversalFile()
        {
            using (StreamWriter sw = File.CreateText(OutputDirectory + "\\Universal.cs"))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen.Templates.Universal1MySqlCs.txt"))
                {
                    if (stream != null)
                    {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen.Templates.Universal2MySqlCs.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
        ...
        public void CreateVbUniversalFile()
        {
            ...
            using (Stream stream = assembly.GetManifestResourceStream("LayerGen.Templates.Universal1MySqlVb.txt"))
            {
                if (stream != null)
                {
                    using (var reader = new StreamReader(stream))
            ...
            using (Stream stream = assembly.GetManifestResourceStream("LayerGen.Templates.Universal2MySqlVb.txt"))
            {
                if (stream != null)
                {
                    using (var reader = new StreamReader(stream))
        ...
        private void CreateCsBusinessLayers()
        {
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen.Templates.BusinessLayer.MySqlCSharp.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
        ...
        private void CreateVbBusinessLayers()
        {
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen.Templates.BusinessLayer.MySqlVbNet.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
        ...
        private void CreateCsDataLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen.Templates.DataLayer.MySqlCSharp.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
        ...
        private void CreateVbDataLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen.Templates.DataLayer.MySqlVbNet.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
