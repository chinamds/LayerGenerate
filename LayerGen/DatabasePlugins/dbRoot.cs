...
namespace LayerGen.DatabasePlugins
{
...
#endif 
    {
		...
		private void Reset()
		{
            ...
            _theSqlConnection = new SqlConnection();
			_isConnected = false;
            ...
            try
            {
                ...
                switch (_driver)
                {
                    case dbDriver.SQL:
                        ...
                        ConnectUsingSqlClient(_driver, _connectionString);
                        this._driverString = MyMetaDrivers.SQL;
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = true;
                        ClassFactory = new LayerGen.DatabasePlugins.Sql.ClassFactory();
                        break;
                    ...
                    case dbDriver.Oracle:
                        ...
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = true;
                        ClassFactory = new LayerGen.DatabasePlugins.Oracle.ClassFactory();
                        break;
                    ...
                    case dbDriver.Access:
                        ...
                        //ClassFactory = new LayerGen.DatabasePlugins.Access.ClassFactory();
                        break;
                    ...
                    case dbDriver.MySql:
                        ...
                        //this.requiredDatabaseName = true;
                        //ClassFactory = new LayerGen.DatabasePlugins.MySql.ClassFactory();
                        break;
                    ...
                    case dbDriver.MySql2:
                        ...
                        this.StripTrailingNulls = true;
                        this.requiredDatabaseName = true;
                        ClassFactory = new LayerGen.DatabasePlugins.MySql5.ClassFactory();
                        break;
                    ...
                    case dbDriver.DB2:
                        ...
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = false;
                        ClassFactory = new LayerGen.DatabasePlugins.DB2.ClassFactory();
                        break;
                    ...
                    case dbDriver.ISeries:
                        ...
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = false;
                        ClassFactory = new LayerGen.DatabasePlugins.ISeries.ClassFactory();
                        break;
                    ...
                    case dbDriver.Pervasive:
                        ...
                        //this.StripTrailingNulls = false;
                        //this.requiredDatabaseName = false;
                        //ClassFactory = new LayerGen.DatabasePlugins.Pervasive.ClassFactory();
                        break;
                    ...
                    case dbDriver.PostgreSQL:
                        ...
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = false;
                        ClassFactory = new LayerGen.DatabasePlugins.PostgreSQL.ClassFactory();
                        break;
                    ...
                    case dbDriver.PostgreSQL8:
                        ...
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = false;
                        ClassFactory = new LayerGen.DatabasePlugins.PostgreSQL8.ClassFactory();
                        break;
                    ...
                    case dbDriver.Firebird:
                        ...
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = false;
                        ClassFactory = new LayerGen.DatabasePlugins.Firebird.ClassFactory();
                        break;
                    ...
                    case dbDriver.SQLite:
                        ...
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = false;
                        ClassFactory = new LayerGen.DatabasePlugins.SQLite.ClassFactory();
                        break;
#if !IGNORE_VISTA
                    case dbDriver.VistaDB:
                        ...
                        //try
                        //{
                        //    LayerGen.DatabasePlugins.VistaDB.MetaHelper mh = new LayerGen.DatabasePlugins.VistaDB.MetaHelper();
                        ...
                        //    this.StripTrailingNulls = false;
                        //    this.requiredDatabaseName = false;
                        //    ClassFactory = new LayerGen.DatabasePlugins.VistaDB.ClassFactory();
                        //}
                        //catch
                        //{
                        //    throw new Exception("Invalid VistaDB connection or VistaDB not installed");
                    ...
                    case dbDriver.Advantage:
                        ...
                        this.StripTrailingNulls = false;
                        this.requiredDatabaseName = false;
                        ClassFactory = new LayerGen.DatabasePlugins.Advantage.ClassFactory();
                    ...
                    case dbDriver.Plugin:
                        ...
                        ClassFactory = new LayerGen.DatabasePlugins.Plugin.ClassFactory(plugin);
                        break;
        ...
        private void ConnectUsingSqlClient(dbDriver driver, string connectionString)
        {
            SqlConnection cn = new SqlConnection(connectionString.Replace("\"", ""));
            cn.Open();
            this._defaultDatabase = GetDefaultDatabaseBySqlClient(cn, driver);
            cn.Close();
        }
        ...
        internal SqlConnection TheSqlConnection
        {
            get
            {
                if (this._theSqlConnection.State != ConnectionState.Open)
                {
                    this._theSqlConnection.ConnectionString = this._connectionString;
                    this._theSqlConnection.Open();
                }

                return this._theSqlConnection;
            }
        }

        private string GetDefaultDatabaseBySqlClient(SqlConnection cn, dbDriver driver)
		{
...
//                        	throw new ApplicationException("Cannot load Plugin(s) " + fileNames.ToString(), err);
        ...
        private SqlConnection _theSqlConnection = new SqlConnection();
	}
