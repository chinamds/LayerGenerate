    ...
    public class SqlServer : IDatabasePlugin
    {
        ...
        private void CreateCsDataLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\Data\\" + Common.GetSafeCsName(Common.GetCsPropertyName(objName)) + "Obj.cs"))
                {
                    ...
                    dataLayerTemplate.Replace("{26}", "TA.Business");
                    ...
                    objcopyPart.AppendLine(string.Format("I{0} {1} = new {0}Obj();", strObjName, strObjNameCopy));
                    foreach (var field in fields)
                    {
        ...
        private void CreateCsControllerLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen35.Templates.DataLayer.SqlServerCSharpController.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
        ...
        private void CreateCsBILayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen35.Templates.DataLayer.SqlServerCSharpI.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\Interfaces\\I" + Common.GetSafeCsName(Common.GetCsPropertyName(objName)) + ".cs"))
                {
                    ...
                    //dataLayerTemplate.Replace("{9}", strKeyFieldName);
                    dataLayerTemplate.Replace("{26}", "TA.Business.Interfaces");                  
        ...
        private void CreateCsCollectionLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen35.Templates.DataLayer.SqlServerCSharpCollection.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\Data\\" + Common.GetSafeCsName(Common.GetCsPropertyName(objName)) + "Collection.cs"))
                {
                    dataLayerTemplate.Replace("{1}", Common.GetSafeCsName(Common.GetCsPropertyName(objName)));
        ...
        private void CreateCsICLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen35.Templates.DataLayer.SqlServerCSharpIC.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
        ...
        private void CreateCsRepoLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen35.Templates.DataLayer.SqlServerCSharpRepo.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\Repository\\" + Common.GetSafeCsName(Common.GetCsPropertyName(objName)) + "Repository.cs"))
                {
                    ...
                    dataLayerTemplate.Replace("{26}", "TA.Data");
                    dataLayerTemplate.Replace("{13}", "TADB");
        ...
        {
            if (!Directory.Exists(OutputDirectory + "\\Dto"))
            {
                Directory.CreateDirectory(OutputDirectory + "\\Dto");
            }
            foreach (string objectName in Objects.Split(';'))
            {
                //UpdateProgress(_progressNdx, Objects.Split(';').Length * 2);
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen35.Templates.DataLayer.SqlServerCSharpDto.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\Dto\\" + Common.GetSafeCsName(Common.GetCsPropertyName(objName)) + "Dto.cs"))
                {
                    dataLayerTemplate.Replace("{1}", Common.GetSafeCsName(Common.GetCsPropertyName(objName)));
        ...
        private void CreateCsInitDataLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen35.Templates.DataLayer.SqlServerCSharpInit.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\InitData\\" + Common.GetSafeCsName(Common.GetCsPropertyName(objName)) + ".cs"))
                {
                    dataLayerTemplate.Replace("{1}", Common.GetSafeCsName(Common.GetCsPropertyName(objName)));
        ...
        private void CreateJavaEntityLayers()
        {
            ...
            foreach (string objectName in Objects.Split(';'))
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("LayerGen35.Templates.DataLayer.SqlServerJavaEntity.txt"))
                {
                    if (stream != null)
                    {
                        using (var reader = new StreamReader(stream))
                ...
                using (StreamWriter sw = File.CreateText(OutputDirectory + "\\Entity\\" + Common.GetSafeCsName(Common.GetCsPropertyName(objName)) + "Dto.cs"))
                {
                    ...
                    {
                        if (field.IsPrimaryKey)
                            fieldsPart.AppendLine("@Id @GeneratedValue(strategy=IDENTITY) @DocumentId");
                        else
                        {
                            string columnDef = "";
                            string nullable = "";
                            ...
                            {
                                columnDef = string.Format("@Column(name=\"{0}\", unique=true{1}, length={2})", field.FieldName, nullable, field.SqlLength);
                            }
                            else
                            {
                                columnDef = string.Format("@Column(name=\"{0}\", unique=true{1})", field.FieldName, nullable);
                            }

                            fieldsPart.AppendLine(columnDef);
                            if (field.JavaMappingType == "text")
        ...
        private bool IsUniqueKey(string tableName, string fieldName) // sp_indexes @is_unique 
        {
            using (var connection = new SqlConnection())
            {
                connection.ConnectionString = ConnectionString;
                using (var command = new SqlCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@is_unique", 1);
                        ...
                        using (var ds = new DataSet())
                        {
                            ...
                            if (ds.Tables.Count > 0)
                            {
                                foreach (DataRow row in ds.Tables[0].Rows)
                                {
                                    ...
                                    try
                                    {
                                        field.SqlLength = (int)row["LENGTH"];
                                    }
                                    catch
                                    {
                                        field.SqlLength = 0;
